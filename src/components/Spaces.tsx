          ...
          {t.spaces.items.map((s) => (
            ...
            >
              <div className="flex items-baseline justify-between gap-4">
                ...
                <span className="text-[0.68rem] text-[var(--color-muted)] tracking-widest uppercase">
                  {t.spaces.pairLabel}
                </span>
              </div>
              <p className="mt-2 lg:mt-3 text-[0.88rem] leading-relaxed text-[var(--color-ink-soft)]">
                {s.note}
              </p>
              <p className="mt-4 lg:mt-6 pt-3 lg:pt-4 border-t border-[var(--color-line-soft)] text-[0.78rem] lg:text-[0.88rem] text-[var(--color-clay-deep)] font-medium">
                {s.pair}
              </p>
            </article>
          ))}
