...
export const ms: Dict = {
  ...
  fabrics: {
    ...
    swatches: [
      { name: "Linen Wheat", type: "Sunscreen 5%", opacity: "Menapis cahaya", hex: "#D9C9A2" },
      { name: "Stone Mist", type: "Dim-out", opacity: "Kurangkan silau", hex: "#C4BCA8" },
      { name: "Inkwell", type: "Blackout", opacity: "Privasi penuh", hex: "#2D2D2A" },
      { name: "Sandbar", type: "Sunscreen 3%", opacity: "Cahaya siang lembut", hex: "#C8B68C" },
      { name: "Bone", type: "Penapis cahaya", opacity: "Basuhan lembut", hex: "#EAE2CC" },
      { name: "Walnut", type: "Dim-out", opacity: "Nada hangat", hex: "#8B5A3C" },
      { name: "Tobacco", type: "Sunscreen 5%", opacity: "Menapis cahaya", hex: "#A89072" },
      { name: "Char", type: "Blackout", opacity: "Privasi penuh", hex: "#3A382F" },
    ],
  },
  spaces: {
